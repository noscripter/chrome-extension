// Generated on 2015-03-02 using generator-chrome-extension 0.3.0
'use strict';
    ...
    watch: {
      ...
      js: {
        files: [
          ...
          '!<%= config.app %>/scripts/core/node_modules/**',
          '<%= config.app %>/scripts/_contentscript.js',
          '<%= config.app %>/scripts/_options.js',
